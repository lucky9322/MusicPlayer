...
import com.zdd.musicplayer.aidl.IOnSongChangedListener;
import com.zdd.musicplayer.aidl.IOnPlayStatusChangedListener;
import com.zdd.musicplayer.aidl.IOnPlayListChangedListener;
...
//  设置播放列表，返回下一首歌曲，为该播放列表设置一个id，用于区分不同歌单
...
//  设置播放模式 0 列表播放（默认，播放到列表最后时停止播放），1 单曲循环，2列表循环，3随机播放
